    ...
    <div>
      <section className="h-[200px] flex items-center justify-center bg-primary-dark">
        <div className="text-center text-white">
          <p className="font-semibold tracking-light font-noto text-2xl md:text-3xl mb-6">Terms & Conditions</p>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className="bg-white rounded-2xl shadow-lg p-8">
            ...
            <div className="space-y-6 text-gray-700">
              <div>
                <p className="font-semibold tracking-light font-noto text-2xl md:text-3xl mb-6">1. Acceptance of Terms</p>
              ...
              <div>
                <p className="font-semibold tracking-light font-noto text-2xl md:text-3xl mb-6">2. Product Information</p>
              ...
              <div>
                <p className="font-semibold tracking-light font-noto text-2xl md:text-3xl mb-6">3. Orders and Payment</p>
              ...
              <div>
                <p className="font-semibold tracking-light font-noto text-2xl md:text-3xl mb-6">4. Shipping and Delivery</p>
              ...
              <div>
                <p className="font-semibold tracking-light font-noto text-2xl md:text-3xl mb-6">5. Returns and Refunds</p>
              ...
              <div>
                <p className="font-semibold tracking-light font-noto text-2xl md:text-3xl mb-6">6. Intellectual Property</p>
                <p>All content on this website is the property of Purvaj Ayurveda and may not be reproduced without written permission.</p>
              </div>

              <div>
                <p className="font-semibold tracking-light font-noto text-2xl md:text-3xl mb-6">7. Limitation of Liability</p>
              ...
              <div>
                <p className="font-semibold tracking-light font-noto text-2xl md:text-3xl mb-6">8. Governing Law</p>
              ...
              <div>
                <p className="font-semibold tracking-light font-noto text-2xl md:text-3xl mb-6">9. Contact Information</p>
