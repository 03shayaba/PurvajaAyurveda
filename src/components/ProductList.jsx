  ...
  return (
    <section className="py-12 bg-[#FFFAF5]">
      <div className="max-w-7xl mx-auto px-4">
        <h2 className="font-serif text-2xl md:text-3xl font-bold text-center mb-2">All Products</h2>
          ...
          {filteredProducts.map((product) => (
            ...
            >
              ...
              <div className="flex-grow px-2">
                <h3 className="font-serif text-lg font-bold text-gray-900 mb-1 leading-tight group-hover:text-[#2D5A27] transition-colors line-clamp-2 min-h-[3rem] flex items-center">
                  {product.name}
                </h3>
